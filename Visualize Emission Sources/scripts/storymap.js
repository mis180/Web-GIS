...
var grayscale =   L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    ...
    streets   = L.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}', {
                     maxZoom: 22,
...
var baseMaps = {
    "<span style='color: gray'>Схема ОСМ</span>": grayscale,
    "Streets": streets
};
